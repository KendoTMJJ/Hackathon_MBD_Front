...
import {
  User as UserIcon, // ⬅️ alias para evitar cualquier confusión
  Camera,
  Save,
  Edit3,
  MapPin,
...
export default function ProfilePage() {
  const { user, isAuthenticated, isLoading, logout } = useAuth0(); // ⬅️ isLoading bien escrito
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
      ...
      <Scrollbar style={{ height: "calc(100vh - 64px)", width: "100%" }}>
