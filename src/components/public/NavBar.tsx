...
export default function NavBar() {
  ...
  // Alinea el locale de Auth0 con el idioma activo de i18next
            ...
            {!isAuthenticated ? (
              ...
              <>
                <button
                  ...
                  aria-haspopup="menu"
                  aria-expanded={open}
                  aria-label={t("navbar.profile", { defaultValue: "Mi perfil" })}
                >
                  {user?.picture ? (
                    <img
                  ...
                  <span className="hidden sm:inline text-sm">
                    {user?.name ?? t("navbar.profile", { defaultValue: "Mi perfil" })}
                  </span>
                </button>
